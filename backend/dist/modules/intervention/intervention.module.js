...
const intervention_controller_1 = require("./intervention.controller");
let InterventionModule = class InterventionModule {
};
exports.InterventionModule = InterventionModule;
exports.InterventionModule = InterventionModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([intervention_record_entity_1.InterventionRecord])],
